import ValueStore from 'react-native-value-store'
...
module.exports = class TabView extends Component {
  constructor(props) {
    super(props);
  ...
  return (
    <View style={{flex: 1,backgroundColor: 'white', justifyContent: 'center', alignItems:'center'}}>
      ...
      <View style={{flex: 1, flexDirection: 'row'}}>
        ...
        <View style={{flex: 1, padding: 5}}>
        <Switch
          value={(this.state && this.state.daylight) || false}
          onValueChange={(value) => {
              this.setState({daylight: value})
            }}
          // Color props are iOS-only
          // thumbTintColor={'white'} // Removes shadow
          tintColor={"rgba(230,230,230,1)"}
